...
documents = [
  ...
  Document(
    page_content='我最喜欢的食物是意大利面，尤其是番茄酱的那种。', metadata={'page': 5}
  ),
  Document(
    page_content='昨晚我做了一个奇怪的梦，梦见自己在太空飞行。', metadata={'page': 6}
  ),
  ...
  Document(
    page_content='他们一起计划了一次周末的野餐，希望天气能好。', metadata={'page': 9}
  ),
...
print(
  db.similarity_search_with_relevance_scores(
    '我养了一只猫，叫笨笨', score_threshold=0.4
  )
)
