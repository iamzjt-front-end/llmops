...
def upgrade():
  ...
  op.create_table(
    ...
    sa.Column(
      'message_token_count', sa.Integer(), server_default=sa.text('0'), nullable=False
    ),
    sa.Column(
      'message_unit_price',
    ...
    sa.Column(
      'answer_token_count', sa.Integer(), server_default=sa.text('0'), nullable=False
    ),
    sa.Column(
      'answer_unit_price',
      sa.Numeric(precision=10, scale=7),
    ...
    sa.Column(
      'total_token_count', sa.Integer(), server_default=sa.text('0'), nullable=False
    ),
    sa.Column(
      'total_price',
      sa.Numeric(precision=10, scale=7),
  ...
  op.create_table(
    ...
    sa.Column(
      'observation', sa.Text(), server_default=sa.text("''::text"), nullable=False
    ),
