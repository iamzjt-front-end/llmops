...
def upgrade():
  ...
  op.create_table(
    ...
    sa.Column(
      'source',
      sa.String(length=255),
      server_default=sa.text("'HitTesting'::character varying"),
      nullable=False,
    ),
  ...
  op.create_table(
    ...
    sa.Column(
      'character_count', sa.Integer(), server_default=sa.text('0'), nullable=False
    ),
  ...
  op.create_table(
    ...
    sa.Column(
      'mode',
      sa.String(length=255),
      server_default=sa.text("'automic'::character varying"),
      nullable=False,
    ),
    sa.Column(
      'rule',
